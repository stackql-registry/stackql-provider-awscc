...
Use the following StackQL query and manifest file to update a <code>segment_definition</code> resource, using [__`stack-deploy`__](https://pypi.org/project/stack-deploy/).
