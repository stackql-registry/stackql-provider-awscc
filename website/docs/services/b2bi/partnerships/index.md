...
<tbody>
  ...
  <tr>
    ...
    <td><code>partnerships_list_only</code></td>
...
Use the following StackQL query and manifest file to update a <code>partnership</code> resource, using [__`stack-deploy`__](https://pypi.org/project/stack-deploy/).
