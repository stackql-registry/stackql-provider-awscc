...
<tbody>
  ...
  <tr>
    ...
    <td><code>assessment_targets</code></td>
  ...
  <tr>
    ...
    <td><code>assessment_targets_list_only</code></td>
...
resources:
  - name: assessment_target
    props:
      ...
      - name: resource_group_arn
        value: '{{ resource_group_arn }}'`}</CodeBlock>
...
Use the following StackQL query and manifest file to update a <code>assessment_target</code> resource, using [__`stack-deploy`__](https://pypi.org/project/stack-deploy/).
