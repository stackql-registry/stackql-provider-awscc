...
<table>
<tbody>
<tr><th>Name</th><th>Datatype</th><th>Description</th></tr><tr><td><CopyableCode code="version_id" /></td><td><code>string</code></td><td>The ID of an existing version of the resource to set as the default.</td></tr>
...
## `SELECT` examples
Gets all <code>resource_default_versions</code> in a region.
```sql
SELECT
region,
version_id,
