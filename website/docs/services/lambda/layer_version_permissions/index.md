...
<tr><td><CopyableCode code="organization_id" /></td><td><code>string</code></td><td>With the principal set to ASTERIX;, grant permission to all accounts in the specified organization.</td></tr>
<tr><td><CopyableCode code="principal" /></td><td><code>string</code></td><td>An account ID, or ASTERIX; to grant layer usage permission to all accounts in an organization, or all AWS accounts (if organizationId is not specified).</td></tr>
