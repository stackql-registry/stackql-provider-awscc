...
Use the following StackQL query and manifest file to update a <code>direct_connect_gateway_attachment</code> resource, using [__`stack-deploy`__](https://pypi.org/project/stack-deploy/).
