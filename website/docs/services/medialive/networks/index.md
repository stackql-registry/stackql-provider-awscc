...
<tbody>
  ...
  <tr>
    ...
    <td><code>networks_list_only</code></td>
...
Use the following StackQL query and manifest file to update a <code>network</code> resource, using [__`stack-deploy`__](https://pypi.org/project/stack-deploy/).
