...
<tr><td><b>Id</b></td><td><CopyableCode code="awscc.lookoutmetrics.alerts" /></td></tr>
</tbody>
</table>
...
<table>
<tbody>
<tr><th>Name</th><th>Datatype</th><th>Description</th></tr><tr><td><CopyableCode code="alert_name" /></td><td><code>string</code></td><td>The name of the alert. If not provided, a name is generated automatically.</td></tr>
...
```sql
/*+ create */
INSERT INTO awscc.lookoutmetrics.alerts (
 AnomalyDetectorArn,
...
```sql
/*+ delete */
DELETE FROM awscc.lookoutmetrics.alerts
