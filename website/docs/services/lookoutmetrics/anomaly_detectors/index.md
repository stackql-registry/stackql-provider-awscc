...
<tr><td><b>Id</b></td><td><CopyableCode code="awscc.lookoutmetrics.anomaly_detectors" /></td></tr>
</tbody>
</table>
...
```sql
/*+ create */
INSERT INTO awscc.lookoutmetrics.anomaly_detectors (
...
```sql
/*+ delete */
DELETE FROM awscc.lookoutmetrics.anomaly_detectors
