...
Use the following StackQL query and manifest file to update a <code>intelligent_prompt_router</code> resource, using [__`stack-deploy`__](https://pypi.org/project/stack-deploy/).
