...
<tr><td><CopyableCode code="exclusion_windows" /></td><td><code>array</code></td><td>Each object in this array defines a time exclusion window for this SLO. The time exclusion window is used to exclude breaching data points from affecting attainment rate, error budget, and burn rate metrics.</td></tr>
