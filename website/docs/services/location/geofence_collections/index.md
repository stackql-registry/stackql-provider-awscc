...
<tr><td><b>Id</b></td><td><CopyableCode code="awscc.location.geofence_collections" /></td></tr>
</tbody>
</table>
...
<tbody>
  ...
  <tr>
    ...
    <td><code>geofence_collections_list_only</code></td>
...
Use the following StackQL query and manifest file to update a <code>geofence_collection</code> resource, using [__`stack-deploy`__](https://pypi.org/project/stack-deploy/).
