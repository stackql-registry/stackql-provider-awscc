...
<tbody>
  ...
  <tr>
    ...
    <td><code>continuous_deployment_policies</code></td>
  ...
  <tr>
    ...
    <td><code>continuous_deployment_policies_list_only</code></td>
...
Use the following StackQL query and manifest file to update a <code>continuous_deployment_policy</code> resource, using [__`stack-deploy`__](https://pypi.org/project/stack-deploy/).
