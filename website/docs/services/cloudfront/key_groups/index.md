...
Use the following StackQL query and manifest file to update a <code>key_group</code> resource, using [__`stack-deploy`__](https://pypi.org/project/stack-deploy/).
