...
<tbody>
  ...
  <tr>
    ...
    <td><code>snapshot_block_public_accesses_list_only</code></td>
...
Use the following StackQL query and manifest file to update a <code>snapshot_block_public_access</code> resource, using [__`stack-deploy`__](https://pypi.org/project/stack-deploy/).
