...
<tr><td><b>Id</b></td><td><CopyableCode code="awscc.ec2.transit_gateway_route_table_propagations" /></td></tr>
</tbody>
</table>
...
<tbody>
  ...
  <tr>
    ...
    <td><code>transit_gateway_route_table_propagations</code></td>
  ...
  <tr>
    ...
    <td><code>transit_gateway_route_table_propagations_list_only</code></td>
...
resources:
  - name: transit_gateway_route_table_propagation
    props:
      ...
      - name: transit_gateway_attachment_id
        value: '{{ transit_gateway_attachment_id }}'`}</CodeBlock>
