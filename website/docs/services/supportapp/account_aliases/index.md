...
Use the following StackQL query and manifest file to update a <code>account_alias</code> resource, using [__`stack-deploy`__](https://pypi.org/project/stack-deploy/).
