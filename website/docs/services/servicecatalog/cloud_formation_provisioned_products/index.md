...
Use the following StackQL query and manifest file to update a <code>cloud_formation_provisioned_product</code> resource, using [__`stack-deploy`__](https://pypi.org/project/stack-deploy/).
