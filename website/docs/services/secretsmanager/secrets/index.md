...
<table>
<tbody>
<tr><th>Name</th><th>Datatype</th><th>Description</th></tr><tr><td><CopyableCode code="description" /></td><td><code>string</code></td><td>The description of the secret.</td></tr>
...
## `SELECT` examples
Gets all <code>secrets</code> in a region.
```sql
SELECT
region,
description,
