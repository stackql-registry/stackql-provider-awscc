...
Lists <code>config_rules</code> in a region or regions, for all properties use <a href="/services/config/config_rules/"><code>config_rules</code></a>
