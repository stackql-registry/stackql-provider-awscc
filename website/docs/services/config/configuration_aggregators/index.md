...
<table>
<tbody>
<tr><th>Name</th><th>Datatype</th><th>Description</th></tr><tr><td><CopyableCode code="account_aggregation_sources" /></td><td><code>array</code></td><td></td></tr>
...
## `SELECT` examples
Gets all <code>configuration_aggregators</code> in a region.
```sql
SELECT
region,
