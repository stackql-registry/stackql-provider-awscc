...
<tr><td><CopyableCode code="flow_size" /></td><td><code>string</code></td><td>Determines the processing capacity and feature set of the flow. Set this optional parameter to LARGE if you want to enable NDI outputs on the flow.</td></tr>
<tr><td><CopyableCode code="ndi_config" /></td><td><code>object</code></td><td>Specifies the configuration settings for NDI outputs. Required when the flow includes NDI outputs.</td></tr>
<tr><td><CopyableCode code="flow_ndi_machine_name" /></td><td><code>string</code></td><td>A prefix for the names of the NDI sources that the flow creates.(ReadOnly)</td></tr>
