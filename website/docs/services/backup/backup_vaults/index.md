    ...
    props:
      ...
      - name: lock_configuration
        value:
          ...
          changeable_for_days: '{{ changeable_for_days }}'`}</CodeBlock>
...
Use the following StackQL query and manifest file to update a <code>backup_vault</code> resource, using [__`stack-deploy`__](https://pypi.org/project/stack-deploy/).
