...
Use the following StackQL query and manifest file to update a <code>traffic_distribution_group</code> resource, using [__`stack-deploy`__](https://pypi.org/project/stack-deploy/).
