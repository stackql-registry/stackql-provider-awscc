...
<tr><td><b>Id</b></td><td><CopyableCode code="awscc.iotfleethub.applications" /></td></tr>
</tbody>
</table>
...
```sql
/*+ create */
INSERT INTO awscc.iotfleethub.applications (
 ApplicationName,
 RoleArn,
 region
)
...
```sql
/*+ delete */
DELETE FROM awscc.iotfleethub.applications
